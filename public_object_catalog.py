...
OBJECT_LABELS = {
    ...
    "satin": "Satin-textured rigid coupon",
    "coin": "Embossed disk",
    "thread_array": "Multi-scale thread array",
    "bump_array": "Spherical bump array",
    "coin_relief": "Coin relief",
    "knurled_ring": "Diamond-knurled ring",
    "phillips_head": "Phillips screw head",
    "gear_face": "Gear face",
    "herringbone_plate": "Rigid herringbone coupon",
    "microgroove_plate": "Multi-frequency microgroove coupon",
    "hex_socket_bolt": "Hex-socket bolt head",
    "spiral_groove_disk": "Spiral-grooved disk",
    "woven_grid_plate": "Rigid woven-grid coupon",
    "serrated_key": "Serrated key",
    "procedural_fourier_relief": "Random Fourier relief",
    "procedural_scratch_field": "Random scratch field",
    "procedural_thread_patch": "Random thread patch",
    "procedural_voronoi_relief": "Random Voronoi relief",
    "procedural_radial_lattice": "Random radial lattice",
    "procedural_branching_grooves": "Random branching grooves",
    "procedural_anisotropic_bands": "Random anisotropic bands",
    "procedural_boolean_relief": "Random Boolean relief",
}
